...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Moomo 沐哞 — 把碎念交給你的小怪獸" },
      { name: "twitter:title", content: "Moomo 沐哞 — 把碎念交給你的小怪獸" },
      { property: "og:description", content: "Moomo 沐哞 是一個私密情緒樹洞。把今天的不爽餵給你的小怪獸，看著牠變化、收集配件、完成治癒任務。" },
      { name: "twitter:description", content: "Moomo 沐哞 是一個私密情緒樹洞。把今天的不爽餵給你的小怪獸，看著牠變化、收集配件、完成治癒任務。" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/908a4b7d-9863-4c7d-b5db-4c4dd3738945" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/908a4b7d-9863-4c7d-b5db-4c4dd3738945" },
