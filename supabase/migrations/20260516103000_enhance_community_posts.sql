-- Community feed hardening and interaction counters.
-- Run this in Supabase/Lovable before deploying the updated community UI.
...
-- Keep user edits scoped to caption/status and prevent client-side counter spoofing.
...
-- Maintain comment_count atomically.
